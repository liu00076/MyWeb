...
public interface GirlBaseDao extends BaseRepository<Girl> {
	...
	@Results({@Result(column = "id", property = "id" , jdbcType = JdbcType.INTEGER ,id = true  ),@Result(column = "age", property = "age" , jdbcType = JdbcType.INTEGER ),@Result(column = "cup_size", property = "cupSize" , jdbcType = JdbcType.VARCHAR ) })
	@Override
